...
void block_convert(std::ifstream &reader, std::ofstream &writer, float *read_buf, _u64 npts, _u64 ndims) {
...
int main(int argc, char **argv) {
  if (argc != 5) {
    diskann::cout << argv[0] << " input_filename.tsv output_filename.bin dim num_pts>" << std::endl;
    exit(-1);
  }
